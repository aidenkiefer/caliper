...
from packages.common.schemas import PriceBar, Order, Position, TradingMode, OrderSide, OrderType, TimeInForce
...
class SMACrossoverStrategy(Strategy):
    ...
    def generate_signals(self, portfolio: PortfolioState) -> List[Signal]:
        ...
        return self._detect_crossover(short_sma, long_sma, prev_short_sma, prev_long_sma, latest_bar)
    ...
    def risk_check(
        ...
        for signal in signals:
            ...
            existing_position = next(
                (p for p in portfolio.positions if p.symbol == signal.symbol),
                None
            )
