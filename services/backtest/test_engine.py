...
class TestBacktestEngineRun:
    ...
    def test_run_raises_error_on_empty_data(
        self, engine: BacktestEngine, mock_strategy: MockStrategy, default_config: BacktestConfig
    ):
    ...
    def test_run_initializes_strategy_with_backtest_mode(
        self, engine: BacktestEngine, sample_bars: List[PriceBar], default_config: BacktestConfig
    ):
    ...
    def test_run_filters_data_by_date_range(
        self, engine: BacktestEngine, default_config: BacktestConfig
    ):
...
class TestStrategyExecution:
    ...
    def test_executes_buy_order(self, engine: BacktestEngine, default_config: BacktestConfig):
...
class TestSlippageAndCommission:
    ...
    def test_applies_slippage_to_fill_price(self, engine: BacktestEngine):
