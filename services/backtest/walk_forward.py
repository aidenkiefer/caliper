...
class WalkForwardEngine:
    ...
    def _process_window(
        ...
        out_of_sample_data = self._filter_data(data, window.out_of_sample_start, window.out_of_sample_end)
    ...
    def _optimize_parameters(
        ...
        for params in combinations:
            ...
            if objective_value is not None:
                if best_value is None or self._is_better(objective_value, best_value, wf_config.objective):
    ...
    def _build_result(
        ...
        aggregated_equity = self._aggregate_equity_curves(window_results, backtest_config.initial_capital)
    ...
    def _calculate_aggregated_metrics(
        ...
        win_rate, winning_trades, losing_trades, avg_win, avg_loss, profit_factor = (
        ...
        return PerformanceMetrics(
            ...
            max_drawdown_pct=max_drawdown / initial_capital * Decimal('100') if initial_capital else Decimal('0'),
            win_rate=win_rate,
