...
class RegretCalculator:
    ...
    def calculate(
        ...
        hold_cash_return = baseline_results.get("hold_cash", {}).metrics.total_return if "hold_cash" in baseline_results else Decimal("0")
        buy_and_hold_return = baseline_results.get("buy_and_hold", {}).metrics.total_return if "buy_and_hold" in baseline_results else Decimal("0")
        random_return = baseline_results.get("random", {}).metrics.total_return if "random" in baseline_results else None
