...
class CircuitBreaker:
    ...
    def update_drawdown(
        ...
        elif (total_drawdown_pct >= self._total_warning_pct or 
              daily_drawdown_pct >= self._daily_warning_pct):
    ...
    def _transition_to(
        ...
        event_type = "tripped" if new_state == CircuitBreakerState.OPEN else (
            "warning" if new_state == CircuitBreakerState.HALF_OPEN else "reset"
        )
