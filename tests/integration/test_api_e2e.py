...
class TestFactoriesInTests:
    ...
    def test_mock_strategy_structure(self):
        ...
        required_keys = [
            "strategy_id", "name", "description", "status", "mode",
            "config", "performance", "created_at", "updated_at"
        ]
    ...
    def test_mock_run_structure(self):
        ...
        required_keys = [
            "run_id", "strategy_id", "run_type", "status",
    ...
    def test_mock_position_structure(self):
        ...
        required_keys = [
            "position_id", "strategy_id", "symbol", "quantity",
            "unrealized_pnl", "risk_metrics", "entry_orders"
        ]
