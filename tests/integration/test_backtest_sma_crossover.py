...
class TestSMACrossoverBacktestIntegration:
    ...
    @pytest.mark.xfail(reason="SMA Crossover strategy has Decimal/float type mismatch at line 168. Backend Agent needs to fix.")
...
class TestIntegrationEdgeCases:
    ...
    def test_handles_volatile_price_action(
        ...
        for i in range(100):
            ...
            volatile_data.append(get_mock_price_bar({
