...
class TestKillSwitchBlocksOrders:
    ...
    @pytest.mark.skip(
        reason="Orders router mock kill switch not connected to controls - Backend Agent TODO"
    )
...
class TestKillSwitchStatus:
    ...
    def test_get_strategy_specific_status(self, client: TestClient):
        ...
        response = client.get(
            "/v1/controls/kill-switch", params={"strategy_id": "status_test_strategy"}
        )
...
class TestKillSwitchEdgeCases:
    ...
    def test_global_switch_affects_all_strategies(
    ...
    def test_strategy_switch_only_affects_that_strategy(
        self, client: TestClient, safe_order_request: dict
    ):
