...
class TestOrderStateTransitions:
    ...
    def test_pending_can_transition_to_submitted(
        self, oms: OrderManagementSystem, sample_order: dict
    ):
    ...
    def test_submitted_can_transition_to_filled(
        self, oms: OrderManagementSystem, sample_order: dict
    ):
    ...
    def test_submitted_can_transition_to_partially_filled(
        self, oms: OrderManagementSystem, sample_order: dict
    ):
    ...
    def test_submitted_can_transition_to_cancelled(
        self, oms: OrderManagementSystem, sample_order: dict
    ):
